...
#### click koro Message a model er +sign--->search & click: supabase--->click: Create a row--->supabase dashboard e jaw--->supabase er SQL Editor tab e jaw--->query.sql paste koro--->click koro: run
